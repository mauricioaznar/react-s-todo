...
`;
export type DeleteCatMutationFn = Apollo.MutationFunction<
  DeleteCatMutation,
...
`;
export type UpdateCatMutationFn = Apollo.MutationFunction<
  UpdateCatMutation,
...
`;
export type CreateCatMutationFn = Apollo.MutationFunction<
  CreateCatMutation,
...
`;
export type UploadCatPhotosMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useUploadCatPhotosMutation(
