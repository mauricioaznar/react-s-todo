...
export default function ConsistencySolution () {
    ...
    return <Box>
        ...
        <ul style={{ fontStyle: 'italic', margin: 0 }}>
            ...
            <li>Same data gets reused across all components and is retrieved from parent ancestor</li>
            <li>Likes get only updated if response was successfully</li>
        </ul>
        <Stack sx={{ my: 2 }} spacing={2} direction={'row'} alignItems={'center'} justifyContent={'center'}>
